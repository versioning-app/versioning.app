'use client';
import { ElkNode, ElkNodeData } from '@/components/dashboard/flow/nodes';
...
export const getLayoutedNodes = async (
  ...
  const graph = {
    ...
    children: nodes.map((n) => {
      const isHorizontal =
        graphOptions['elk.direction'] === 'RIGHT' ||
        graphOptions['elk.direction'] === 'LEFT';

      n.data.__direction = graphOptions['elk.direction'];
